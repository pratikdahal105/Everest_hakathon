        ...
        <div id="layoutSidenav_content">
          <main>
            <div className="container-fluid px-4">
              <h1 className="mt-4">Borrower Dashboard</h1>
              <div className="row">
                ...
                <div className="col-xl-3 col-md-6">
                  <div className="card bg-danger text-white mb-4">
                    <div className="card-body">Overdue Payment</div>
                    <div className="card-footer d-flex align-items-center justify-content-between">
                      <div className="small text-white stretched">
                        <b>$500</b>
                      </div>
              ...
              <div className="card mb-4">
                <div className="card-header">
                  ...
                  Total Pool Balance Available
                </div>
                <div className="card-body">
                  <h5 className="card-title bg-light p-3 rounded">$10000000</h5>
                  <button className="btn btn-primary mt-3">Request</button>
                </div>
              </div>
              <div className="card mb-4">
                <div className="card-header">
